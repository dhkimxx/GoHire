...
func (wq *WebhookQuery) QueryUser() *UserQuery {
...
func (wq *WebhookQuery) WithUser(opts ...func(*UserQuery)) *WebhookQuery {
	query := (&UserClient{config: wq.config}).Query()
...
func (wq *WebhookQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Webhook, error) {
	...
	if query := wq.withUser; query != nil {
		if err := wq.loadUser(ctx, query, nodes, nil,
			func(n *Webhook, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (wq *WebhookQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Webhook, init func(*Webhook), assign func(*Webhook, *User)) error {
...
func (wq *WebhookQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := wq.ctx.Fields; len(fields) > 0 {
		...
		if wq.withUser != nil {
			_spec.Node.AddColumnOnce(webhook.FieldUserID)
		}
	}
